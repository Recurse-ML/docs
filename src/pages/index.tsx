...
const META_DESCRIPTION = "Documentation for Recurse ML - an AI-powered static analysis tool that finds bugs tests and linters miss. Understands external libraries and complex codebases so you can ship fast with confidence";
